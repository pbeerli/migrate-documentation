...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
\DeclareRobustCommand{\migrate}{\textsc{migrate}\xspace}
\makeatother

\makeatletter
\DeclareRobustCommand{\ms}{\textsc{ms}\xspace}
\makeatother

\makeatletter
\DeclareRobustCommand{\phylip}{\textsc{PHYLIP}\xspace}
\makeatother

\makeatletter
\DeclareRobustCommand{\fastmigrate}{{\textsc{migrate-n-mpi}}\xspace}
\makeatother

\makeatletter
\DeclareRobustCommand{\genetree}{{\textsc{genetree}}\xspace}
\makeatother
...
\makeatletter
\DeclareRobustCommand{\beast}{\textsc{Beast}\xspace}
\makeatother
...
\newcommand{\entrylabel}[1]{\mbox{\textrm{#1}}\hfill}
